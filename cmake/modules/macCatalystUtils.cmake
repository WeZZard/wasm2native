...
function(get_maccatalyst_build_flavor out_var sdk flavor)
  if(W2N_ENABLE_MACCATALYST AND sdk STREQUAL "OSX")
...
function(get_versioned_target_triple target_out_var sdk arch version)
  if(W2N_SDK_${sdk}_IS_SIMULATOR)
    # The version goes before the "-simulator".
    set(target "${W2N_SDK_${sdk}_ARCH_${arch}_TRIPLE}")
    string(REPLACE "-simulator" "" target "${target}")
    set(target "${target}${version}-simulator")
  else()
    set(target "${W2N_SDK_${sdk}_ARCH_${arch}_TRIPLE}${version}")
  endif()
...
function(get_target_triple target_out_var target_variant_out_var sdk arch)
  ...
  if(maccatalyst_build_flavor STREQUAL "ios-like")
    set(target "${arch}-apple-ios${W2N_DARWIN_DEPLOYMENT_VERSION_MACCATALYST}-macabi")
  ...
  elseif(maccatalyst_build_flavor STREQUAL "zippered")
    set(target "${arch}-apple-macosx${W2N_DARWIN_DEPLOYMENT_VERSION_OSX}")
    set(target_variant "${arch}-apple-ios${W2N_DARWIN_DEPLOYMENT_VERSION_MACCATALYST}-macabi")

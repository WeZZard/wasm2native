...
#ifndef W2N_AST_RESILIENCE_EXPANSION_H
#define W2N_AST_RESILIENCE_EXPANSION_H
...
enum class ResilienceExpansion : unsigned {
  ...
  ///
  /// Minimal expansion will generally pass all resilient types
  /// indirectly.
  Minimal,
...
#endif // LLVM_W2N_AST_CAPTURE_INFO_H

...
/// with ranges, map creates an \c iterator_range which applies a function
/// to all the elements in another \c iterator_range.
///
/// \c IntRange is a template class for iterating over a range of
/// integers.
///
/// \c indices returns the range of indices from \c [0..size()) on a
/// subscriptable type.

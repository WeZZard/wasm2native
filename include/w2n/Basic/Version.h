...
public:
  ...
  /// or equal to any other CompilerVersion, as in the case of building w2n
  ...
  /// an argument to -w2n-version.
  ///
  /// This is not the same as the set of w2n versions that have ever existed,
  ...
  /// result; for example "-w2n-version 3" at one point instructed the
...
/// -w2n-version flags that may have been used in a particular invocation of
/// the compiler.
std::pair<unsigned, unsigned> getw2nNumericVersion();

/// Retrieves a string representing the complete w2n version, which includes
/// the w2n supported and effective version numbers, the repository version,
/// and the vendor tag.
std::string getw2nFullVersion(Version effectiveLanguageVersion =
...
/// and \c getw2nRevision returns the version tuple in string format.

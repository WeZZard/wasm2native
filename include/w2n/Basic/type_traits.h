...
#ifndef W2N_BASIC_TYPETRAITS_H
#define W2N_BASIC_TYPETRAITS_H
...
#define W2N_DEFINED_HAS_FEATURE
...
///
/// Unlike \c llvm::isPodLike, this trait should produce a precise result
/// and is not intended to be specialized.
template <typename T>
struct IsTriviallyCopyable {
#if defined(_LIBCPP_VERSION) || W2N_COMPILER_IS_MSVC
...
struct IsTriviallyConstructible {
  ...
  || __has_keyword(__is_trivially_constructible)
...
struct IsTriviallyDestructible {
  ...
  || __has_keyword(__is_trivially_destructible)
...
#ifdef W2N_DEFINED_HAS_FEATURE
#undef __has_feature
#endif

#endif // W2N_BASIC_TYPETRAITS_H

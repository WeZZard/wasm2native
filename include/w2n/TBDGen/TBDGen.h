...
struct TBDGenOptions {
  ...
  /// The path to a Json file indicating the module name to install-name
  /// map used by @_originallyDefinedIn
  std::string ModuleInstallNameMapPath;

  /// For these modules, TBD gen should embed their symbols in the emitted
  /// tbd file. Typically, these modules are static linked libraries. Thus
  /// their symbols are embedded in the current dylib.
